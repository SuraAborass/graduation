...
class ProfileController extends GetxController {
  ...
  TextEditingController updateAddressController = TextEditingController(text: MyApp.appUser!.address);
  TextEditingController updatePhoneController = TextEditingController(text: MyApp.appUser!.phone);
  ...
  Future<void> updateInfo() async {
    if (updatePasswordController.text != updateConfirmPasswordController.text) {
      SnackBars.showError('كلمة المرور وتأكيد كلمة المرور غير متطابقتين');
      return;
    }
